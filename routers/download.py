...
from src.enum_tool.file_type_enum import FileTypeEnum
...
def get_audio():
    ...
    file = None
    if file_type == FileTypeEnum.AUDIO:  # 音频下载
    ...
    elif file_type == FileTypeEnum.IMAGE:  # 图片下载
        filename = request.args.get("filename")
        file = send_file(os.path.join(os.getcwd(), "resources","article_image", filename))
    return file
